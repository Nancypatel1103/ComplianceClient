...
## How to create organization user and full access user hotspot 2.0. 
1. The way to create hotspot 2.0 in organization user and full access user is the same.
2. The Organization user and Full Excess user have access to **edit, create, and delete**. But in its list only create details are shown and details of other organizations are not shown.
3. Go to the **SSIDs** menu.
   
   ![image-2](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/1b7a6e9c-0beb-4028-8053-284e00c0cdd6)

4. After going to the **SSIDs** menu, click on the **Hotspot 2.0** tab.

   ![image-29](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/d4868d69-d554-40e4-9f24-61d1205de2e0)

5. So now click on the **Add New** button.

   ![image-30](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/42a7e789-0ca8-4cc6-8d2f-99687ed304e3)

6. Fill in the details in General and NAI Realms. The information on **how to fill in its details and how to create a new NAI Realm** is given above. `Note:- There is no option to select an organization in it, it will directly select the organization created in it`.

    ![image-31](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/d1c4a539-98a9-4207-b343-20c0457110f4)

8. Next, click the **Save** button on the located right side.

   ![image-32](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/192e922c-d534-4bff-97d2-0476dc9c9763)

9. As soon as you click on the Save button, you will get a message on the screen that the **Hotspot profile is created successfully**.
...
3. Go to the **Edit** button of SSID to which you want to connect Hotspot 2.0.
...
5. After activating the **Hotspot 2.0**, the option of **Hotspot Profiles** will be shown below and the hotspot will be connected by default.
    ...
    ![image-35](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/8fc46390-b870-49d3-87cf-baa5fd44375d)
...
7. As soon as you click on the **Update** button, you will get a message on the screen that the **SSID details are updated successfully**.
    ...
    ![image-36](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/5b7935ab-20ff-4f50-a355-1ec332c34962)

8. Click on the **Access Point** menu located on the left side.

    ![image-37](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/8018849f-c313-41cf-9c59-66ea58a81995)

9. Click on the **Edit** button of the device of the access point you want to connect SSID to.

    ![image-38](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/c6cdd003-89dd-42a9-889f-5d422569cd1f)

10. After clicking, a new window will open. If you scroll a little there, you will get Radio Configuration. Radio Configuration is of 2 types (1) 2.4 GHz and (2) 5.8 GHz.Then select Radio-SSID by clicking on the select SSID arrow. **For example:- Radio-SSID-infi**.
...
12. As soon as you click on the **Save** button, you will get a message on the screen that **Device configuration is updated successfully**.

    ![image-21](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/efbb24a3-e5ef-4ad0-9132-4b3c53d89969)

13. ```
    Full access and Organization user mode also have access to delete and edit, how to do that is explained in how to edit hotspot2.0 and how to delete hotspot 2.0.
    ```

### How to create Read read-only
1. Go to the **SSIDs** menu.
   
   ![image-2](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/1b7a6e9c-0beb-4028-8053-284e00c0cdd6)

2. After going to the **SSIDs** menu, click on the **Hotspot 2.0** tab.

   ![image-44](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/9fd0e6d1-0c1a-4385-8ed5-1daf68d9cb88)

3. A read-only user can only read and has no **create, edit, or delete** access.

   ![image-45](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/4f13c79e-c40e-402c-a7c7-483d26e767a6)
