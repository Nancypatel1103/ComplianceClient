...
1. The Organization user has access to **edit, create, and delete**. But in its list only create details are shown and details of other organizations are not shown.
...
5. Fill in the details in General and NAI Realms. The information on **how to fill in its details and how to create a new NAI Realm** is given above. `Note:- There is no option to select an organization in it, it will directly select the organization created in it`.
...
2. Go to the SSID you want to connect to the Hotspot.
3. Click on the Edit button located on the right side of your SSID.
...
3. So now click on the **Add New** button.

   ![image-39](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/51790450-4e18-429a-92a8-447ce2bb1200)

4. Fill in the details in General and NAI Realms. The information on **how to fill in its details and how to create a new NAI Realm** is given above. `Note:- There is no option to select an organization in it, it will directly select the organization created in it`.

    ![image-40](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/244b7e76-1745-47f6-b39d-f360a53e3020)

5. Next, click the **Save** button on the located right side.

   ![image-32](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/192e922c-d534-4bff-97d2-0476dc9c9763)

6. As soon as you click on the Save button, you will get a message on the screen that the **Hotspot profile is created successfully**.

   ![image-41](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/66713c5c-185f-4a75-b926-e98160b8a724)

## How to Use Organization User
1. Click on the SSIDs tab.

   ![image-42](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/ac9a9c6d-1a87-4364-a14a-12ddb5bc0ec1)
...
5. After activating the **Hotspot 2.0**, the option of **Hotspot Profiles** will be shown below and the hotspot will be connected by default.
    ...
    ![image-43](https://github.com/Nancypatel1103/ComplianceClient/assets/153616269/781af4de-9528-4b09-b57b-69c32790c8f1)
